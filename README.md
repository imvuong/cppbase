...
\cond [![MIT license](http://img.shields.io/badge/license-MIT-brightgreen.svg)](http://opensource.org/licenses/MIT) [![Build Status](https://travis-ci.org/imvuong/cppbase.svg?branch=coverity_scan)](https://travis-ci.org/imvuong/cppbase)[![Coverity Scan Build Status](https://scan.coverity.com/projects/12565/badge.svg)](https://scan.coverity.com/projects/12565) [![Coverage Status](https://coveralls.io/repos/github/imvuong/cppbase/badge.svg?branch=coverity_scan)](https://coveralls.io/github/imvuong/cppbase?branch=coverity_scan) \endcond
